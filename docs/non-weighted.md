...
+ **All subscribers**: All active subscribers of a given platform, by default a subscriber is considered to be inactive after there has been no activity on any of subscribers' devices for 35 consecutive days
